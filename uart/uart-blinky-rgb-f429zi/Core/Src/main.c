...
/* USER CODE BEGIN PV */
uint8_t Rx_data[10];  //  creating a buffer of 5 bytes for "AT+LED"
uint8_t testReceiveData[10];  //  creating a buffer of 10 bytes
int red_flag;
int green_flag;
int blue_flag;
/* USER CODE END PV */
...
/* USER CODE BEGIN Header_StartWaitTask */
/**
